...
zig build c -Doptimize=ReleaseSafe -Dtarget=x86_64-macos -p $RELEASE/sdfgen-$VERSION-macos-x86-64
zig build c -Doptimize=ReleaseSafe -Dtarget=aarch64-macos -p $RELEASE/sdfgen-$VERSION-macos-aarch64
